...
const PostDetails = () => {
  ...
  return (
    <div>
        <button className='py-3' onClick={() => navigate(-1)}>
          <img src={back} alt="back" className='w-10 h-10 text-sky-500' />
        </button>
      <ThemeProvider>
      <section class="bg-white dark:bg-[#242424] rounded-xl py-8 lg:py-10 postdetails border border-gray-300" id={theme}>
  <div class="max-w-2xl mx-auto px-4">
      <div class="flex justify-between items-center mb-6">
        <h2 class="text-lg lg:text-2xl font-bold text-gray-900 dark:text-white">Discussion (4)</h2>
    </div>
    <form class="mb-6">
        <div class="py-2 px-4 mb-4 bg-white rounded-lg rounded-t-lg border border-gray-200 dark:bg-gray-800 dark:border-gray-700">
            <label for="comment" class="sr-only">Your comment</label>
            <textarea id="comment" rows="6"
                class="px-0 w-full text-sm text-gray-900 border-0 focus:ring-0 focus:outline-none dark:text-gray-500 dark:placeholder-gray-400 dark:bg-gray-800"
